...
import { getCurrentUserSession, requestAuthPrompt, subscribeToUserSession, type UserSession } from "../../utils/orderPortal";
...
function MenuItemCard({ item, isOutletOpen = true }: { item: MenuItem; isOutletOpen?: boolean }) {
  ...
  const handleAdd = () => {
    ...
    addItem({ id: item.id, name: item.name, price: item.price, image: item.image, canteenId: item.canteenId });
  };
    ...
    <div className="menu-item-card">
      ...
      <div className="menu-item-body">
        ...
        <div className="menu-item-controls">
          ...
          <button className="menu-item-add" onClick={handleAdd} disabled={isItemAvailable ? !isOutletOpen : true}>
