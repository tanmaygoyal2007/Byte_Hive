...
const founders = [
  {
    ...
    description: "Leading the project with architecture, frontend, and backend implementation.",
  ...
  },
  {
    ...
    description: "Core contributor focusing on user experience, system design, and feature development.",
